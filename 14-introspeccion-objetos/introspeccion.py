'''
La instrospeccion es la habilidad para determinar el tipo de un objeto en tiempo de ejecucion
'''
...
# Por otro lado el id, devuelve un id, identificador unico para cada objeto
print('------------------------')
nombre = "Pelayo"
print(id(nombre))
...
##################################
'''
El módulo inspect nos proporciona diferentes funciones para consultar información de objetos.
'''
